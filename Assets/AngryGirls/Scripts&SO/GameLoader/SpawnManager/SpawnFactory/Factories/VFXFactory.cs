...
namespace Angry_Girls
{
    ...
    public class VFXFactory : MonoBehaviour, ICoreFactory<VFX_Type>
    {
        ...
        [SerializeField] private GameObject VFX_Eclipse;
        ...
        private void Awake()
        {
            ...
            VFX_Eclipse = Resources.Load(VFX_Type.VFX_Eclipse.ToString()) as GameObject;
        }
        ...
        public PoolObject SpawnGameobject(VFX_Type VFX_Type, Vector3 position, Quaternion rotation)
        {
            switch (VFX_Type)
            {
                ...
                case VFX_Type.VFX_Eclipse:
                    {
                        return (Instantiate(VFX_Eclipse, position, rotation)).GetComponent<PoolObject>();
                    }
                default:
                    {
