...
namespace Angry_Girls
{
    public static class Repository
    {
        ...
        private const string _gameProgressKey = nameof(CharactersSaveData);
        ...
        public static bool LoadState()
        {
            ...
            try
            {
                ...
                _currentState =
                    JsonConvert.DeserializeObject<Dictionary<string, string>>(serializedState)
            ...
            {
                Debug.LogError($"Repository.LoadState: Failed to load game state: {e.Message}");
                _currentState = new Dictionary<string, string>();
                return false;
            }
        }
        ...
        public static bool HasGameSave()
        {
            ...
            return _currentState.ContainsKey(_gameProgressKey);
        }
        ...
        public static void SaveState()
        {
            ...
            {
                Debug.LogError($"Repository.SaveState: Failed to save game state: {e.Message}");
            }
        }
        ...
        public static T GetData<T>()
        {
            ...
            if (!_currentState.TryGetValue(key, out var serializedData) ||
            ...
            {
                Debug.LogError(
                    $"Repository.GetData<{key}> FAILED: {e.Message}\n{e.StackTrace}");
        ...
        public static void SetData<T>(T value) where T : class
        {
            ...
            try
            {
                ...
                Debug.Log(
                    $"Repository.SetData<{key}>: Saved data (size: {serializedData.Length} chars)");
            }
            catch (JsonException e)
            {
                Debug.LogError(
                    $"Repository.SetData<{key}>: Failed to serialize data: {e.Message}");
            }
        }
