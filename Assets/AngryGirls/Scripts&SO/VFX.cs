...
namespace Angry_Girls
{
    ...
    public class VFX : PoolObject
    {
        ...
        {
            if (!CoreManager.Instance.PoolManager.vfxPoolDictionary[_config.Vfxtype].Contains(this))
            {
                CoreManager.Instance.PoolManager.AddObject<VFX_Type>(_config.Vfxtype, CoreManager.Instance.PoolManager.vfxPoolDictionary, this);
            }
        }
